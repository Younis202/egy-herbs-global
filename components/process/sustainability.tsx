...
import { Globe, Heart, Leaf, Recycle, Droplets, Sun, Wind, Users } from "lucide-react";
...
const initiatives = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1594761051656-153faa4ea1ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
  },
  {
    icon: Globe,
    title: "Carbon Neutral",
    description: "Working towards carbon neutrality across our operations",
    image: "https://images.unsplash.com/photo-1569511166187-1566bbb3a186?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-emerald-100 max-w-2xl mx-auto">
            Our sustainability initiatives ensure a better future for our planet, communities, and customers. 
            We believe that quality products and environmental responsibility go hand in hand.
          </p>
        </motion.div>
          ...
          {initiatives.map((initiative, index) => (
            ...
            >
              <Card className="h-full bg-white/10 border-white/20 overflow-hidden rounded-xl">
                ...
                <div className="p-6">
                  <h3 className="text-white text-xl font-semibold mb-3">{initiative.title}</h3>
        ...
        >
          ...
          <div className="mt-12 text-center">
            <p className="text-emerald-100 max-w-2xl mx-auto">
              Our sustainability journey is ongoing. We continuously seek new ways to reduce our environmental footprint 
              while supporting the communities that make our business possible.
            </p>
          </div>
        </motion.div>
      </div>
