      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            certifications that validate our commitment to quality, sustainability, and ethical practices.
          </p>
        </motion.div>
            ...
            >
              <Card className="overflow-hidden h-full border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <h4 className="text-sm font-medium text-emerald-600 mb-3">Key Benefits:</h4>
        ...
        >
          <div className="bg-emerald-50 rounded-xl p-8 max-w-3xl mx-auto">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Our Commitment to Excellence</h3>
            <p className="text-gray-700">
              These certifications are more than just logos—they represent our ongoing commitment to providing 
              products that meet the highest standards of quality, sustainability, and ethical production. 
              We regularly undergo rigorous inspections and audits to maintain these certifications.
            </p>
          </div>
        </motion.div>
      </div>
