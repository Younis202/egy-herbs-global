...
import { ChevronLeft, ChevronRight, Award, Star, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-6 font-light leading-relaxed">
            ...
            their exceptional quality, rich aroma, and authentic Egyptian heritage.
          </p>
        </motion.div>
        ...
        <div className="relative mt-8">
          <Button
            variant="outline"
            size="icon"
            className={`absolute -left-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 shadow-lg rounded-full h-10 w-10 border-gray-200 hover:bg-emerald-50 hover:border-emerald-200 transition-all duration-300 backdrop-blur-sm ${scrollPosition <= 10 ? 'opacity-40 cursor-not-allowed' : 'opacity-100'}`}
            onClick={() => scroll('left')}
          ...
          <Button
            variant="outline"
            size="icon"
            className={`absolute -right-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 shadow-lg rounded-full h-10 w-10 border-gray-200 hover:bg-emerald-50 hover:border-emerald-200 transition-all duration-300 backdrop-blur-sm ${scrollPosition >= maxScroll - 10 ? 'opacity-40 cursor-not-allowed' : 'opacity-100'}`}
        ...
        >
          ...
          <p className="text-gray-700 text-sm italic font-light leading-relaxed">
            "The quality of these Egyptian herbs is truly exceptional. You can taste the authenticity in every dish — it's like bringing the essence of Egypt into my kitchen."
          </p>
          <div className="flex items-center gap-3 mt-4">
            ...
            <div>
              <p className="text-emerald-700 text-sm font-medium">Chef Maria Santos</p>
              <p className="text-gray-500 text-xs">Executive Chef, Cairo Cuisine</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <span className="text-amber-800 font-medium text-sm">Quality Award 2024</span>
        </motion.div>
      </div>
    </section>
  );
