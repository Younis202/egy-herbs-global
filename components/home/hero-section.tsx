...
import { ChevronDown, MessageCircle, Leaf, Shield, Award, ArrowRight } from 'lucide-react';
...
export function HeroSection() {
  ...
  const whatsappUrl = `https://wa.me/201234567890?text=${encodeURIComponent("Hello! I'm interested in your premium Egyptian herbs and spices. Could you provide more information?")}`;
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 bg-emerald-600/20 backdrop-blur-sm px-3 py-1.5 rounded-full mb-4 border border-emerald-400/30 shadow-sm shadow-emerald-300/10">
            ...
            <span className="text-emerald-50 text-xs font-medium">Premium Egyptian Quality</span>
          </div>
          
          {/* Main Heading with enhanced text treatment */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 leading-tight">
            <span className="block text-white drop-shadow-sm">Nature's Finest</span>
          ...
          <p className="text-base text-emerald-50/90 mb-6 max-w-xl leading-relaxed font-light">
            Discover the authentic flavors and healing properties of premium Egyptian herbs and spices, 
            carefully harvested from the fertile lands of the Nile Valley.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/products">
              <Button 
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-6 py-2 rounded-full shadow-lg shadow-emerald-700/20 hover:shadow-emerald-500/30 transition-all duration-300 hover:scale-105 flex items-center gap-2 text-sm font-medium"
              >
                Explore Collection
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-emerald-50/90 text-xs">Premium Quality</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="bg-emerald-700/30 backdrop-blur-sm p-1.5 rounded-full border border-emerald-400/20 shadow-sm shadow-emerald-400/5">
                <Award className="h-4 w-4 text-emerald-300" />
              </div>
              <span className="text-emerald-50/90 text-xs">Certified Organic</span>
            </div>
          </div>
        </div>
      </div>
