...
import { Facebook, Twitter, Instagram, Youtube, MapPin, Phone, Mail, ArrowRight, Send, Leaf } from 'lucide-react';
...
const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
  ...
  const productLinks = [
    ...
    { href: '/products?category=legumes', label: 'Legumes' }
  ];
    ...
    <footer className="bg-gradient-to-b from-emerald-900 to-emerald-950 text-emerald-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-emerald-200/80 text-sm leading-relaxed">
                  Join our newsletter for exclusive offers and updates on our latest premium Egyptian herbs and spices.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-emerald-300/80 leading-relaxed">
              Premium quality Egyptian herbs, spices, and seeds sourced directly from the fertile lands of Egypt.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-medium text-emerald-200 mb-5 text-lg border-b border-emerald-700/50 pb-2 font-serif">Quick Links</h3>
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <motion.li 
                  ...
                  whileHover="hover"
                >
                  <Link href={link.href} className="text-emerald-300/80 hover:text-emerald-200 transition-colors flex items-center group text-sm">
          ...
          {/* Products */}
          <div>
            <h3 className="font-medium text-emerald-200 mb-5 text-lg border-b border-emerald-700/50 pb-2 font-serif">Products</h3>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-medium text-emerald-200 mb-5 text-lg border-b border-emerald-700/50 pb-2 font-serif">Contact</h3>
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <span className="text-sm text-emerald-300/80">info@egyherbsglobal.com</span>
              </li>
              <li className="flex items-start group">
                <Phone className="w-4 h-4 mr-3 text-emerald-400 flex-shrink-0 mt-0.5 group-hover:text-emerald-300 transition-colors" />
                <span className="text-sm text-emerald-300/80">+20 123 456 789</span>
              </li>
              <li className="flex items-start group">
                <MapPin className="w-4 h-4 mr-3 text-emerald-400 flex-shrink-0 mt-0.5 group-hover:text-emerald-300 transition-colors" />
                <span className="text-sm text-emerald-300/80">Industrial Zone, Cairo, Egypt</span>
              </li>
            </ul>
            
            <div className="mt-6 pt-4 border-t border-emerald-700/30">
              <h4 className="font-medium text-emerald-200 mb-2 text-xs uppercase tracking-wider font-serif">Business Hours</h4>
              <p className="text-xs text-emerald-300/80">Sunday - Thursday: 9:00 AM - 5:00 PM</p>
              <p className="text-xs text-emerald-300/80">Friday - Saturday: Closed</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-6 border-t border-emerald-700/30 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-emerald-400/80">&copy; {new Date().getFullYear()} Egy Herbs Global. All rights reserved.</p>
